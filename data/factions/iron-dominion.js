...
(function() {
  ...
  const units = [
    ...
    // ADDITIONAL CAVALRY UNITS
    {
      name: "Steam Lancers",
      faction: "iron-dominion",
      points_cost: 3,
      role: "Light shock cavalry",
      fragment_interactions: "Grid Node; lance charge bonus",
      flavor_text:
        "Riders on steam-augmented warhorses, carrying piston-driven lances that deliver bone-shattering impacts.",
      description:
        "Mounted on warhorses fitted with steam-powered leg augments, these riders close distance at terrifying speed. Their piston-driven lances fire a pressurized burst on impact, punching through shields and armor alike. Cheap and fast, Steam Lancers are the Iron Dominion's answer to flanking threats — deploy them wide and let momentum do the rest.",
      type: "Cavalry",
      stats: {
        ATK: 9,
        DEF: 3,
      ...
      special: [
        "Grid Node",
        "Lance Charge (+2 ATK on charge)",
      ],
    },
    {
      name: "Gear-Rider Hussars",
      faction: "iron-dominion",
      points_cost: 5,
      role: "Standard medium cavalry",
      fragment_interactions: "Grid Node; Overclock synergy",
      flavor_text:
        "Well-armored cavalry on gear-enhanced mounts, forming the backbone of Dominion mounted operations.",
      description:
        "The workhorse of the Iron Dominion's mounted arm, Gear-Rider Hussars combine mechanical reliability with battlefield versatility. Their mounts are augmented with clockwork musculature that never tires, and their sabers are edge-hardened with fragment-tempered steel. They can charge, hold ground, or pursue — solid all-rounders that anchor any cavalry formation.",
      type: "Cavalry",
      stats: {
        ATK: 12,
        DEF: 4,
      ...
      special: [
        "Grid Node",
        "Mechanical Endurance (ignore first Fatigue effect each turn)",
        "Sabre Sweep (attack all engaged enemies once per charge)",
      ],
    },
    {
      name: "Aether Dragoons",
      faction: "iron-dominion",
      points_cost: 6,
      role: "Elite ranged cavalry",
      fragment_interactions: "Grid Node; Aether-powered carbines",
      flavor_text:
        "Elite mounted troops armed with aether carbines — they fire from horseback with devastating accuracy before closing to finish the job.",
      description:
        "The Dominion's premier mounted skirmishers, Aether Dragoons combine the speed of cavalry with lethal mid-range firepower. Their aether carbines fire concentrated energy bolts while at full gallop, softening targets before the Dragoons close for a sabre charge. They excel at hit-and-run operations, exploiting gaps in the enemy line before withdrawing to reload.",
      type: "Cavalry",
      stats: {
        ATK: 12,
        DEF: 3,
      ...
      special: [
        "Grid Node",
        "Mounted Fire (may shoot and move in same activation)",
        "Carbine Volley (RNG 12 attack before charge)",
      ],
    },
    {
      name: "Iron Stampede",
      ...
      fragment_interactions: "Grid Anchor; devastating mass charge",
      flavor_text:
        "Massively armored cavalry on clockwork-augmented destriers. When they charge, the ground shakes.",
      description:
        "The heaviest mounted unit in the Iron Dominion arsenal — riders and mounts alike encased in layered steam-plate, their clockwork destriers driven to speed by supercharged boiler cores. An Iron Stampede charge is an industrial catastrophe in motion, crushing formations, scattering infantry, and leaving wreckage in its wake. They are slow to turn but unstoppable in a straight line.",
      type: "Cavalry",
      stats: {
        ATK: 15,
        DEF: 5,
      ...
      special: [
        "Grid Anchor",
        "Devastating Charge (+3 ATK on charge; target must pass MOR check or flee)",
        "Heavy Armor",
        "Momentum (cannot voluntarily stop during charge move)",
      ],
    },
    ...
    // LEGENDARY WAR MACHINE
    {
      ...
      flavor_text:
        "The crown jewel of Iron Dominion engineering — a walking fortress of steam, steel, and raw mechanical supremacy.",
      description:
        "The Titan Engine Imperius is the single greatest feat of Iron Dominion engineering — a colossal bipedal war machine standing three stories tall, powered by a fragment reactor core that hums with barely-contained energy. Its twin aether cannons devastate formations at extreme range, its armored hull shrugs off concentrated fire, and its Grid Anchor effect extends across the entire battlefield. Fielding the Imperius is a declaration: the age of flesh is over. Only one may be taken per army.",
      type: "War Machine",
      stats: {
        ATK: 30,
        DEF: 8,
      ...
      special: [
        "Grid Anchor",
        "Twin Aether Cannons (may fire twice per activation at different targets)",
        "Reactor Core (on destruction, 6\" blast deals 12 ATK to all units)",
        "Supreme Grid (+2 ATK to all Grid Node units within 12\")",
        "Massive",
        "Fearless",
