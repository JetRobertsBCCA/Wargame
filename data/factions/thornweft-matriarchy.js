(function() {
  ...
  gameData.commanders.push(
    {
      ...
      base_stats: { Command: 10, Knowledge: 9, Leadership: 8, Agility: 5, Health: 85 },
      battle_stats: { ATK: 4, DEF: 5, HP: 10, MOV: 6, RNG: 8, MOR: 9 },
      points_cost: 24,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 10, Leadership: 6, Agility: 7, Health: 75 },
      battle_stats: { ATK: 5, DEF: 3, HP: 8, MOV: 7, RNG: 12, MOR: 8 },
      points_cost: 22,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 9, Leadership: 7, Agility: 8, Health: 80 },
      battle_stats: { ATK: 5, DEF: 4, HP: 9, MOV: 7, RNG: 8, MOR: 8 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 6, Knowledge: 8, Leadership: 5, Agility: 10, Health: 65 },
      battle_stats: { ATK: 7, DEF: 2, HP: 6, MOV: 9, RNG: 4, MOR: 9 },
      points_cost: 19,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 8, Leadership: 9, Agility: 5, Health: 90 },
      battle_stats: { ATK: 3, DEF: 5, HP: 10, MOV: 5, RNG: 4, MOR: 9 },
      points_cost: 21,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 9, Leadership: 7, Agility: 4, Health: 95 },
      battle_stats: { ATK: 3, DEF: 6, HP: 11, MOV: 4, RNG: 6, MOR: 9 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 9, Knowledge: 10, Leadership: 8, Agility: 7, Health: 70 },
      battle_stats: { ATK: 3, DEF: 3, HP: 8, MOV: 7, RNG: 12, MOR: 9 },
      points_cost: 22,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 5, Leadership: 9, Agility: 4, Health: 120 },
      battle_stats: { ATK: 5, DEF: 7, HP: 14, MOV: 5, RNG: 1, MOR: 10 },
      points_cost: 23,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 8, Leadership: 6, Agility: 10, Health: 70 },
      battle_stats: { ATK: 5, DEF: 2, HP: 7, MOV: 16, RNG: 6, MOR: 8 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 8, Leadership: 7, Agility: 6, Health: 85 },
      battle_stats: { ATK: 4, DEF: 4, HP: 9, MOV: 6, RNG: 6, MOR: 8 },
      points_cost: 18,
      level_1_deck: {
  ...
  gameData.units.push(
    // INFANTRY (15 units)
    { name: "Thread-Warden Infantry", faction: "thornweft-matriarchy", points_cost: 1, role: "Core troops", fragment_interactions: "Minor web buffs", flavor_text: "Silk-armored warriors with venom-coated blades", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 1, MOV: 5, RNG: 1, MOR: 6 }, special: ["Venom Strike (1 token on hit)", "Web-Sensitive"] },
    { name: "Silk-Warden Regulars", faction: "thornweft-matriarchy", points_cost: 2, role: "Standard infantry", fragment_interactions: "Web buffs", flavor_text: "Standard Thornweft soldiers with spindle-blades and chitin shields", type: "Infantry", stats: { ATK: 3, DEF: 3, HP: 1, MOV: 5, RNG: 1, MOR: 7 }, special: ["Venom Strike", "Shield Wall", "Web-Walk (ignore web terrain)"] },
    { name: "Gossamer Guard", faction: "thornweft-matriarchy", points_cost: 3, role: "Elite infantry", fragment_interactions: "Defensive web synergy", flavor_text: "Elite warriors in silk-plate armor woven from Matriarch spider-molt", type: "Infantry", stats: { ATK: 4, DEF: 5, HP: 2, MOV: 5, RNG: 1, MOR: 8 }, special: ["Stubborn", "Silk Armor (+1 DEF in web terrain)", "Venom Strike"] },
    { name: "Venom Dancers", faction: "thornweft-matriarchy", points_cost: 3, role: "Skirmish infantry", fragment_interactions: "Poison enhancement", flavor_text: "Agile fighters who coat every strike in layered toxins", type: "Infantry", stats: { ATK: 4, DEF: 2, HP: 1, MOV: 7, RNG: 1, MOR: 7 }, special: ["Venom Strike (2 tokens on hit)", "Dodge (+1 DEF vs melee)", "Hit and Run"] },
    { name: "Web-Spinner Sappers", faction: "thornweft-matriarchy", points_cost: 2, role: "Engineering infantry", fragment_interactions: "Web creation", flavor_text: "Combat engineers who lay web terrain while fighting", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 1, MOV: 5, RNG: 1, MOR: 7 }, special: ["Lay Web Terrain (create 3\" web zone)", "Anchor Construction"] },
    { name: "Silk-Shot Skirmishers", faction: "thornweft-matriarchy", points_cost: 2, role: "Ranged infantry", fragment_interactions: "Venom delivery", flavor_text: "Dart-blowers firing silk-wrapped venom needles", type: "Infantry", stats: { ATK: 3, DEF: 2, HP: 1, MOV: 6, RNG: 8, MOR: 6 }, special: ["Venom Darts (apply 1 venom token at range)", "Skirmish"] },
    { name: "Cocoon Wardens", faction: "thornweft-matriarchy", points_cost: 3, role: "Harvesting infantry", fragment_interactions: "Resource generation", flavor_text: "Specialists who wrap dead enemies for resource extraction", type: "Infantry", stats: { ATK: 3, DEF: 4, HP: 2, MOV: 4, RNG: 1, MOR: 7 }, special: ["Cocoon Harvest (generate 1 resource per adjacent dead enemy)", "Stubborn"] },
    { name: "Phase-Silk Infiltrators", faction: "thornweft-matriarchy", points_cost: 4, role: "Elite stealth infantry", fragment_interactions: "Phase abilities", flavor_text: "Assassins wrapped in light-bending silk", type: "Infantry", stats: { ATK: 5, DEF: 2, HP: 1, MOV: 7, RNG: 1, MOR: 8 }, special: ["Stealth", "Assassinate (+3 ATK vs commanders)", "Phase (teleport 6\" instead of moving)"] },
    { name: "Thread-Seer Acolytes", faction: "thornweft-matriarchy", points_cost: 4, role: "Fate-reading infantry", fragment_interactions: "Fate manipulation", flavor_text: "Apprentice fate-readers who grant minor probability buffs", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 8, MOR: 8 }, special: ["Fate-Read (1 free reroll per turn for nearby allies)", "Fragment User"] },
    { name: "Fang Guard Elite", faction: "thornweft-matriarchy", points_cost: 5, role: "Heavy elite infantry", fragment_interactions: "All buffs", flavor_text: "Personal guard units carrying Fang-Glaives and chitin greatshields", type: "Infantry", stats: { ATK: 5, DEF: 5, HP: 3, MOV: 5, RNG: 1, MOR: 9 }, special: ["Venom Strike (2 tokens)", "Shield Wall", "Bodyguard", "Fearless"] },
    { name: "Shuttle-Consort Militia", faction: "thornweft-matriarchy", points_cost: 1, role: "Cheap screening troops", fragment_interactions: "Minimal", flavor_text: "Male administrative staff armed for desperation defense", type: "Infantry", stats: { ATK: 2, DEF: 2, HP: 1, MOV: 5, RNG: 1, MOR: 5 }, special: ["Expendable", "Screen (block charge lanes)"] },
    { name: "Silk-Blade Duelists", faction: "thornweft-matriarchy", points_cost: 4, role: "Melee specialists", fragment_interactions: "Combat buffs", flavor_text: "Master swordswomen wielding paired spindle-blades", type: "Infantry", stats: { ATK: 5, DEF: 3, HP: 2, MOV: 6, RNG: 1, MOR: 8 }, special: ["Duelist (reroll 1 ATK die in melee)", "Venom Strike", "Counterattack"] },
    { name: "Anchor Guard", faction: "thornweft-matriarchy", points_cost: 3, role: "Objective holders", fragment_interactions: "Web-Anchor defense", flavor_text: "Defenders sworn to protect Web-Anchor points at all costs", type: "Infantry", stats: { ATK: 3, DEF: 5, HP: 2, MOV: 4, RNG: 1, MOR: 9 }, special: ["+2 DEF when within 3\" of Web-Anchor", "Stubborn", "Hold Ground"] },
    { name: "Fear-Weavers", faction: "thornweft-matriarchy", points_cost: 4, role: "Morale warfare", fragment_interactions: "Psychological debuffs", flavor_text: "Warriors who emit subsonic web-vibrations that induce dread", type: "Infantry", stats: { ATK: 3, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 9 }, special: ["Terror Aura (-1 MOR to enemies within 6\")", "Fearless"] },
    { name: "Fate-Blessed Veterans", faction: "thornweft-matriarchy", points_cost: 5, role: "Elite core", fragment_interactions: "All buffs", flavor_text: "Survivors of a hundred webs, their fate-threads hardened by experience", type: "Infantry", stats: { ATK: 5, DEF: 5, HP: 3, MOV: 5, RNG: 1, MOR: 9 }, special: ["Veteran", "Venom Strike", "Reroll 1s", "Web-Walk"] },

    // CAVALRY (5 units)
    { name: "Spiderling Scouts", faction: "thornweft-matriarchy", points_cost: 2, role: "Light cavalry", fragment_interactions: "Speed/web buffs", flavor_text: "Riders on young Loom-Spiders, fast and skittish", type: "Cavalry", stats: { ATK: 3, DEF: 2, HP: 2, MOV: 10, RNG: 4, MOR: 6 }, special: ["Scout", "Web-Walk", "Lay Web Terrain while moving"] },
    { name: "Silk-Rider Lancers", faction: "thornweft-matriarchy", points_cost: 5, role: "Medium cavalry", fragment_interactions: "Charge buffs", flavor_text: "Warriors mounted on Weaver-stage spiders, armed with Fang-Glaives", type: "Cavalry", stats: { ATK: 5, DEF: 4, HP: 3, MOV: 8, RNG: 2, MOR: 8 }, special: ["Wall-Climber", "Charge (+2 ATK)", "Venom Lance (charge applies 2 venom tokens)"] },
    { name: "Matriarch Riders", faction: "thornweft-matriarchy", points_cost: 8, role: "Heavy cavalry", fragment_interactions: "Elite web synergy", flavor_text: "Thread-Seers mounted on Matriarch-stage spiders", type: "Cavalry", stats: { ATK: 6, DEF: 5, HP: 4, MOV: 8, RNG: 4, MOR: 9 }, special: ["Wall-Climber", "Web-Caster (8\" immobilize)", "Mobile Web-Anchor", "Fate-Read (1 reroll/turn)"] },
    { name: "Phase-Silk Cavalry", faction: "thornweft-matriarchy", points_cost: 6, role: "Fast cavalry", fragment_interactions: "Phase abilities", flavor_text: "Riders on spiders wrapped in light-bending silk — they shimmer and teleport", type: "Cavalry", stats: { ATK: 4, DEF: 3, HP: 3, MOV: 12, RNG: 4, MOR: 8 }, special: ["Phase (teleport 8\" instead of normal move)", "Hit and Run", "Stealth"] },
    { name: "Queen-Spawn War-mount", faction: "thornweft-matriarchy", points_cost: 10, role: "Elite cavalry", fragment_interactions: "All buffs", flavor_text: "Loom-Mother mounted on a Queen-Spawn Spider — a walking web-fortress", type: "Cavalry", stats: { ATK: 7, DEF: 6, HP: 5, MOV: 7, RNG: 6, MOR: 10 }, special: ["Wall-Climber", "Mobile Web-Anchor", "Silk Storm (12\" cone AoE)", "Reality Weaving (reshape terrain within 6\")"] },

    // SUPPORT (8 units)
    { name: "Web-Anchor Engineers", faction: "thornweft-matriarchy", points_cost: 4, role: "Network construction", fragment_interactions: "Anchor creation", flavor_text: "Dedicated engineers who deploy and maintain Web-Anchors", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 7 }, special: ["Deploy Web-Anchor (takes 1 activation)", "Repair Anchor", "Web-Walk"] },
    { name: "Venom Alchemists", faction: "thornweft-matriarchy", points_cost: 4, role: "Debuff support", fragment_interactions: "Enhanced poisons", flavor_text: "Poison specialists who coat allied weapons and brew combat toxins", type: "Support", stats: { ATK: 2, DEF: 2, HP: 2, MOV: 5, RNG: 8, MOR: 7 }, special: ["Coat Weapons (+1 venom token to nearby allies' attacks)", "Venom Bomb (6\" blast, 1 token to all hit)"] },
    { name: "Silk Surgeons", faction: "thornweft-matriarchy", points_cost: 3, role: "Healers", fragment_interactions: "Healing silk", flavor_text: "Medics who bind wounds with healing silk bandages", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 4, MOR: 7 }, special: ["Heal (restore 1d3 HP with silk binding)", "Cleanse Venom (remove venom tokens from allies)"] },
    { name: "Fate-Thread Weavers", faction: "thornweft-matriarchy", points_cost: 5, role: "Fate support", fragment_interactions: "Fate manipulation", flavor_text: "Ritual weavers who manipulate probability threads on the battlefield", type: "Support", stats: { ATK: 2, DEF: 2, HP: 2, MOV: 5, RNG: 12, MOR: 8 }, special: ["Fate Manipulation (force 1 enemy reroll per turn)", "Fragment User", "Prophecy"] },
    { name: "Gossamer Trap Layers", faction: "thornweft-matriarchy", points_cost: 3, role: "Terrain control", fragment_interactions: "Trap creation", flavor_text: "Specialists who deploy adhesive web-traps across the battlefield", type: "Support", stats: { ATK: 2, DEF: 3, HP: 1, MOV: 5, RNG: 1, MOR: 6 }, special: ["Lay Gossamer Trap (3\" zone: enemies immobilized for 1 turn)", "Web-Walk"] },
    { name: "Vibration Drummers", faction: "thornweft-matriarchy", points_cost: 3, role: "Morale support", fragment_interactions: "Web-vibration", flavor_text: "Play silk-drums that send tactical commands through the Web", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 8 }, special: ["Inspiring Vibration (+1 MOR to nearby allies)", "Web Pulse (extend command range through Anchors)"] },
    { name: "Spider Handlers", faction: "thornweft-matriarchy", points_cost: 3, role: "Beast support", fragment_interactions: "Spider buffs", flavor_text: "Trainers who command unbonded combat spiders", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 7 }, special: ["Command Spiders", "Calm Beast (prevent frenzy)", "Spawn Spiderling (once per game)"] },
    { name: "Cocoon Processors", faction: "thornweft-matriarchy", points_cost: 4, role: "Resource extraction", fragment_interactions: "Harvesting", flavor_text: "Process cocooned enemies into usable resources", type: "Support", stats: { ATK: 2, DEF: 4, HP: 2, MOV: 4, RNG: 1, MOR: 7 }, special: ["Process Cocoon (convert 1 cocooned enemy into 2 resource tokens)", "Field Repairs (use resources to heal)"] },

    // SCOUTS (3 units)
    { name: "Silk-Shadow Scouts", faction: "thornweft-matriarchy", points_cost: 3, role: "Reconnaissance", fragment_interactions: "Detection", flavor_text: "Spider-mounted scouts in light-bending silk cloaks", type: "Scout", stats: { ATK: 3, DEF: 2, HP: 2, MOV: 10, RNG: 6, MOR: 7 }, special: ["Stealth", "Scout", "Wall-Climber", "Forward Deploy"] },
    { name: "Tremor Sentinels", faction: "thornweft-matriarchy", points_cost: 2, role: "Detection", fragment_interactions: "Vibration sensing", flavor_text: "Web-sensitives who detect movement through ground vibrations", type: "Scout", stats: { ATK: 2, DEF: 2, HP: 1, MOV: 5, RNG: 1, MOR: 7 }, special: ["Detect Hidden Units (12\" tremor-sense)", "Web-Walk", "Anti-Stealth"] },
    { name: "Thread-Reader Outriders", faction: "thornweft-matriarchy", points_cost: 4, role: "Intel gathering", fragment_interactions: "Fate reading", flavor_text: "Fast spider-riders who read enemy fate-threads from a distance", type: "Scout", stats: { ATK: 3, DEF: 3, HP: 2, MOV: 9, RNG: 8, MOR: 8 }, special: ["Fate-Read (reveal enemy unit stats and abilities)", "Wall-Climber", "Relay Commands"] },

    // ARTILLERY (3 units)
    { name: "Silk Catapult", faction: "thornweft-matriarchy", points_cost: 6, role: "Web artillery", fragment_interactions: "Web ammo", flavor_text: "Launches compressed web-bombs that create instant trap terrain", type: "Artillery", stats: { ATK: 4, DEF: 3, HP: 3, MOV: 3, RNG: 24, MOR: 7 }, special: ["Indirect Fire", "Web-Bomb (6\" blast creates web terrain)", "Terrain Denial"] },
    { name: "Venom Mortar", faction: "thornweft-matriarchy", points_cost: 7, role: "Poison artillery", fragment_interactions: "Venom delivery", flavor_text: "Fires shells of concentrated spider-venom", type: "Artillery", stats: { ATK: 5, DEF: 3, HP: 3, MOV: 3, RNG: 24, MOR: 7 }, special: ["Indirect Fire", "Venom Blast (4\" blast, all hit gain 2 venom tokens)", "Poison Cloud (persists 1 turn)"] },
    { name: "Fate-Loom Siege Engine", faction: "thornweft-matriarchy", points_cost: 8, role: "Fate artillery", fragment_interactions: "Fate manipulation", flavor_text: "A mobile loom that weaves and unweaves fate-threads at range", type: "Artillery", stats: { ATK: 3, DEF: 3, HP: 4, MOV: 3, RNG: 30, MOR: 8 }, special: ["Fate Disruption (target unit loses 1 random ability for 2 turns)", "Thread Tangle (target must reroll all successes for 1 turn)"] },

    // SPECIALIST (5 units)
    { name: "Spiderling Swarm", faction: "thornweft-matriarchy", points_cost: 2, role: "Cheap screening", fragment_interactions: "Growth", flavor_text: "Swarms of young spiders that overwhelm through numbers", type: "Specialist", stats: { ATK: 3, DEF: 1, HP: 1, MOV: 8, RNG: 1, MOR: 5 }, special: ["Swarm (3 models count as 1 unit)", "Wall-Climber", "Venom Bite (1 token)", "Expendable"] },
    { name: "Cocoon Bombers", faction: "thornweft-matriarchy", points_cost: 4, role: "Immobilization", fragment_interactions: "Web capture", flavor_text: "Specialist units that lob cocoon grenades to immobilize enemies", type: "Specialist", stats: { ATK: 3, DEF: 3, HP: 2, MOV: 6, RNG: 8, MOR: 7 }, special: ["Cocoon Grenade (4\" blast, immobilize for 1 turn)", "Web-Walk"] },
    { name: "Thread-Cutter Assassins", faction: "thornweft-matriarchy", points_cost: 5, role: "Assassination", fragment_interactions: "Fate-cutting", flavor_text: "Elite killers who sever enemy fate-threads with silk garrotes", type: "Specialist", stats: { ATK: 6, DEF: 2, HP: 2, MOV: 8, RNG: 1, MOR: 9 }, special: ["Stealth", "Assassinate (+3 ATK vs commanders)", "Fate-Sever (killed targets cannot be resurrected)"] },
    { name: "Reality Weavers", faction: "thornweft-matriarchy", points_cost: 6, role: "Terrain manipulation", fragment_interactions: "Reality alteration", flavor_text: "Elite silk-mages who physically reshape the battlefield", type: "Specialist", stats: { ATK: 3, DEF: 3, HP: 2, MOV: 5, RNG: 8, MOR: 8 }, special: ["Terrain Weaving (move or create terrain features within 8\")", "Fragment User", "Web-Walk"] },
    { name: "Silk Wraiths", faction: "thornweft-matriarchy", points_cost: 5, role: "Phase assault", fragment_interactions: "Phase abilities", flavor_text: "Warriors so deeply bonded to the Web they're only partially real", type: "Specialist", stats: { ATK: 5, DEF: 1, HP: 2, MOV: 8, RNG: 1, MOR: 8 }, special: ["Phase (50% miss chance from attacks)", "Teleport (move to any Web-Anchor)", "Ethereal (ignore terrain)"] },

    // WAR MACHINES (11 units)
    { name: "Brood-Mother Spider", faction: "thornweft-matriarchy", points_cost: 12, role: "Spawner/heavy", fragment_interactions: "Spawns spiders", flavor_text: "A massive spider that lays eggs mid-battle, spawning combat reinforcements", type: "War Machine", stats: { ATK: 7, DEF: 6, HP: 10, MOV: 6, RNG: 4, MOR: 10 }, special: ["Spawn Spiderlings (1d3 per turn)", "Wall-Climber", "Venomstrike (paralytic bite)", "Mobile Web-Anchor"] },
    { name: "Silk Colossus", faction: "thornweft-matriarchy", points_cost: 14, role: "Super-heavy siege spider", fragment_interactions: "Web creation", flavor_text: "An enormous spider wrapped in layers of reinforced silk, walking fortress", type: "War Machine", stats: { ATK: 8, DEF: 7, HP: 12, MOV: 5, RNG: 6, MOR: 10 }, special: ["Massive", "Silk Storm (18\" cone AoE + immobilize)", "Creates Web Terrain while moving", "Living Fortress (garrison 3 infantry inside)"] },
    { name: "Gossamer Titan", faction: "thornweft-matriarchy", points_cost: 15, role: "Reality weaver", fragment_interactions: "Fate manipulation", flavor_text: "A Queen-Spawn Spider of staggering proportions — its silk can rewrite geography", type: "War Machine", stats: { ATK: 9, DEF: 6, HP: 13, MOV: 4, RNG: 8, MOR: 10 }, special: ["Reality Weaving (reshape terrain within 12\")", "Fate Command (force 2 rerolls/turn)", "Wall-Climber", "Legendary"] },
    { name: "Venom Engine", faction: "thornweft-matriarchy", points_cost: 9, role: "Poison war machine", fragment_interactions: "Venom delivery", flavor_text: "A spider-construct that sprays concentrated venom across wide areas", type: "War Machine", stats: { ATK: 6, DEF: 5, HP: 8, MOV: 5, RNG: 12, MOR: 10 }, special: ["Venom Spray (12\" cone, 2 venom tokens to all hit)", "Poison Cloud Aura (3\")", "Web-Walk"] },
    { name: "Web-Fortress", faction: "thornweft-matriarchy", points_cost: 10, role: "Defensive structure", fragment_interactions: "Network hub", flavor_text: "A semi-permanent silk structure that serves as a fortified Web-Anchor hub", type: "War Machine", stats: { ATK: 4, DEF: 8, HP: 10, MOV: 0, RNG: 12, MOR: 10 }, special: ["Immobile", "Enhanced Web-Anchor (double teleport range)", "Garrison 5 infantry", "Self-Repairing (heal 1 HP/turn)"] },
    { name: "Fate-Loom Engine", faction: "thornweft-matriarchy", points_cost: 11, role: "Command engine", fragment_interactions: "Fate amplification", flavor_text: "A massive silk-loom operated by Thread-Seers, weaving fate in real time", type: "War Machine", stats: { ATK: 3, DEF: 5, HP: 8, MOV: 3, RNG: 30, MOR: 10 }, special: ["Fate Weaving (force 3 enemy rerolls per turn)", "Thread Amplification (all friendly fate abilities +1)", "Fragile Core"] },
    { name: "Crawler Siege Engine", faction: "thornweft-matriarchy", points_cost: 8, role: "Mobile siege", fragment_interactions: "Web delivery", flavor_text: "An armored spider-construct that scales walls and delivers web-bombs", type: "War Machine", stats: { ATK: 6, DEF: 5, HP: 7, MOV: 6, RNG: 8, MOR: 10 }, special: ["Wall-Climber", "Web-Bomb Launcher", "Siege (double damage vs structures)"] },
    { name: "Skithari (Unique Queen-Spawn)", faction: "thornweft-matriarchy", points_cost: 25, role: "Named monster", fragment_interactions: "Legendary web synergy", flavor_text: "Loom-Mother Vethiss's spider partner — the most intelligent non-humanoid in the Matriarchy", type: "War Machine", stats: { ATK: 9, DEF: 7, HP: 15, MOV: 7, RNG: 8, MOR: 10 }, special: ["Wall-Climber", "Reality Weaving", "Silk Storm (24\" cone)", "Mobile Fortress Web-Anchor", "Legendary (Vethiss only)"] },
    { name: "Phase-Silk Wraith Spider", faction: "thornweft-matriarchy", points_cost: 9, role: "Phase construct", fragment_interactions: "Phase abilities", flavor_text: "A spider that exists between dimensions — semi-transparent and nearly impossible to hit", type: "War Machine", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 10, RNG: 4, MOR: 10 }, special: ["Phase (50% miss chance)", "Teleport", "Wall-Climber", "Ethereal"] },
    { name: "Cocoon Harvester", faction: "thornweft-matriarchy", points_cost: 7, role: "Resource war machine", fragment_interactions: "Harvesting", flavor_text: "A massive spider-construct that wraps and processes enemies in industrial volumes", type: "War Machine", stats: { ATK: 5, DEF: 5, HP: 7, MOV: 5, RNG: 4, MOR: 10 }, special: ["Mass Cocoon (wrap 1d3 adjacent enemies per turn)", "Process (convert cocoons to 3 resource tokens)", "Fearless"] },
    { name: "Trap-Layer Construct", faction: "thornweft-matriarchy", points_cost: 6, role: "Terrain construct", fragment_interactions: "Trap deployment", flavor_text: "An automated spider-construct that scatters Gossamer Traps while patrolling", type: "War Machine", stats: { ATK: 3, DEF: 4, HP: 5, MOV: 6, RNG: 1, MOR: 10 }, special: ["Auto-Trap (lay 1 Gossamer Trap per turn for free)", "Wall-Climber", "Web-Walk"] }
  );
