(function() {
  ...
  gameData.units.push(
    // INFANTRY (15 units)
    { name: "Ashborn Infantry", faction: "emberclaw-warpack", points_cost: 1, role: "Core troops", fragment_interactions: "Minor fire buffs", flavor_text: "Unbonded warriors wielding flame-forged spears", description: "The lowest-caste warriors of the Emberclaw Warpack, Ashborn Infantry are unbonded fighters who have yet to earn a drake companion. Armed with flame-forged spears heated in dragon-breath, they form the expendable front lines of every Emberclaw assault. What they lack in drake-bond synergy they make up for in sheer ferocity — every Ashborn fights knowing that glory in battle is the only path to bonding. Their fire-resistant skin, a result of ritual ash-bathing from birth, allows them to advance through the burning terrain their own army creates.", type: "Infantry", stats: { ATK: 6, DEF: 3, HP: 3, MOV: 5, RNG: 1, MOR: 6 }, special: ["Fire Resistant"] },
