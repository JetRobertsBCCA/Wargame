(function() {
  ...
  gameData.factions.push({
    ...
    faction_bonuses: [
      "All units with Fly ignore terrain when moving",
  ...
  gameData.commanders.push(
    {
      ...
      battle_stats: { ATK: 18, DEF: 5, HP: 33, MOV: 12, RNG: 4, MOR: 9 },
      points_cost: 24,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 12, DEF: 3, HP: 24, MOV: 8, RNG: 10, MOR: 10 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 15, DEF: 4, HP: 27, MOV: 7, RNG: 12, MOR: 7 },
      points_cost: 18,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 27, DEF: 7, HP: 45, MOV: 10, RNG: 5, MOR: 10 },
      points_cost: 35,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 15, DEF: 3, HP: 21, MOV: 16, RNG: 6, MOR: 8 },
      points_cost: 19,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 24, DEF: 4, HP: 36, MOV: 9, RNG: 1, MOR: 10 },
      points_cost: 21,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 12, DEF: 3, HP: 24, MOV: 12, RNG: 10, MOR: 8 },
      points_cost: 17,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 15, DEF: 5, HP: 30, MOV: 8, RNG: 6, MOR: 9 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 21, DEF: 6, HP: 39, MOV: 7, RNG: 4, MOR: 9 },
      points_cost: 23,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 24, DEF: 5, HP: 36, MOV: 10, RNG: 1, MOR: 10 },
      points_cost: 24,
      level_1_deck: {
...

    {
      ...
      battle_stats: { ATK: 15, DEF: 3, HP: 27, MOV: 10, RNG: 12, MOR: 7 },
      points_cost: 21,
      level_1_deck: {
  ...
  gameData.units.push(
    // INFANTRY (15 units)
    { name: "Ashborn Infantry", faction: "emberclaw-warpack", points_cost: 2, role: "Core troops", fragment_interactions: "Minor fire buffs", flavor_text: "Unbonded warriors wielding flame-forged spears", description: "The lowest-caste warriors of the Emberclaw Warpack, Ashborn Infantry are unbonded fighters who have yet to earn a drake companion. Armed with flame-forged spears heated in dragon-breath, they form the expendable front lines of every Emberclaw assault. What they lack in drake-bond synergy they make up for in sheer ferocity — every Ashborn fights knowing that glory in battle is the only path to bonding. Their fire-resistant skin, a result of ritual ash-bathing from birth, allows them to advance through the burning terrain their own army creates.", type: "Infantry", stats: { ATK: 6, DEF: 3, HP: 3, MOV: 7, RNG: 1, MOR: 6 }, special: ["Fire Resistant"] },
    { name: "Emberclaw Warriors", faction: "emberclaw-warpack", points_cost: 2, role: "Standard infantry", fragment_interactions: "Fire buffs", flavor_text: "Standard ground troops with javelin and shield", description: "The backbone of the Warpack's ground forces, Emberclaw Warriors are veteran fighters who've survived their first drake encounter but haven't yet earned a bond. They carry flame-tempered javelins and crude dragon-scale shields scavenged from molting drakes. Capable of ranged harassment with their javelins before closing to melee, they provide the flexible mid-line presence every Emberclaw army needs. Their tribal scarification marks denote kills and campaigns — the more scar-tissue, the more respected the warrior.", type: "Infantry", stats: { ATK: 6, DEF: 3, HP: 3, MOV: 7, RNG: 6, MOR: 7 }, special: ["Fire Resistant", "Javelin Thrower"] },
    { name: "Flameborn Guard", faction: "emberclaw-warpack", points_cost: 3, role: "Elite infantry", fragment_interactions: "Strong fire synergy", flavor_text: "Veterans who have survived the Branding", description: "Warriors who have survived the Branding — a horrific ritual where drake-fire is poured directly onto their flesh until it fuses with their skin. The survivors emerge with fire-hardened bodies and an unshakeable will to fight. Flameborn Guard form disciplined shield walls that radiate heat so intense that attackers risk burns just from proximity. When wounded, the drakeblood infused in their veins ignites, driving them into a calculated fury that makes them more dangerous the closer they are to death.", type: "Infantry", stats: { ATK: 12, DEF: 4, HP: 6, MOV: 7, RNG: 1, MOR: 8 }, special: ["Fire Resistant", "Flame Ward (+1 DEF; attackers take 1 fire damage)", "Drakeblood Fury (+1 ATK when wounded)"] },
    { name: "Pyromancer Adepts", faction: "emberclaw-warpack", points_cost: 3, role: "Magic infantry", fragment_interactions: "Cast fire spells", flavor_text: "Unbonded warriors who channel flame", description: "Unbonded warriors who discovered an alternative path to power — channeling flame directly through fragment-implanted palms. Pyromancer Adepts are feared and somewhat mistrusted within the Warpack, as their power comes from fragments rather than the sacred drake-bond. They hurl bolts of concentrated fire at range, making them invaluable for softening enemy formations before the charge. Their fragment dependency makes them volatile; when a Pyromancer's implant cracks, the resulting detonation is often fatal.", type: "Infantry", stats: { ATK: 9, DEF: 2, HP: 3, MOV: 7, RNG: 10, MOR: 7 }, special: ["Fire Bolt (8\" RNG fire attack)", "Fragment User"] },
    { name: "Emberforged Blades", faction: "emberclaw-warpack", points_cost: 4, role: "Melee specialists", fragment_interactions: "Weapon buffs", flavor_text: "Elite warriors with fragment-infused swords", description: "Elite swordfighters whose weapons are the result of months of forging in drake-fire. Each Emberforged Blade carries a sword that burns perpetually, the fragment shards embedded in the steel maintaining a temperature that can slice through conventional armor like heated wire through wax. These warriors are drawn from the finest duelists in the Warpack and trained in a whirling combat style that turns defense into immediate counter-offense. Their blades ignore conventional armor, making them the answer to heavily-armored opponents.", type: "Infantry", stats: { ATK: 15, DEF: 4, HP: 6, MOV: 8, RNG: 1, MOR: 8 }, special: ["Flame Weapons (ignore 1 DEF)", "Ember Riposte (counterattack deals fire damage; ignores 1 DEF)"] },
    { name: "Hatchery Guard", faction: "emberclaw-warpack", points_cost: 3, role: "Defensive infantry", fragment_interactions: "Defensive buffs", flavor_text: "Protectors of the sacred clutches", description: "Sworn protectors of the Warpack's most sacred asset — the drake eggs. Hatchery Guard are chosen for their patience and iron discipline, rare qualities in the Emberclaw. They fight as immovable anchors, refusing to yield ground under any circumstance. Their thick drake-hide shields and ceremonial ash-plate armor make them the most defensively minded unit in the faction. Off the battlefield, they tend the hatcheries; on it, they protect objectives and flanks with the same maternal ferocity a drake shows its clutch.", type: "Infantry", stats: { ATK: 9, DEF: 5, HP: 6, MOV: 6, RNG: 1, MOR: 9 }, special: ["Stubborn", "Hold Ground (+2 DEF if not moving)"] },
    { name: "Unbonded Berserkers", faction: "emberclaw-warpack", points_cost: 3, role: "Shock troops", fragment_interactions: "Fury buffs", flavor_text: "Warriors seeking death with honor", description: "Warriors who have been rejected by every drake they've approached — a shame so profound that many choose death in battle over continued dishonor. Unbonded Berserkers charge into combat with no regard for personal safety, seeking either a glorious end or enough battle-fury to attract a drake's attention. Their fearlessness is born from having nothing left to lose. They hit harder than almost any infantry unit in the game but crumble under sustained fire. Use them as expendable wrecking balls.", type: "Infantry", stats: { ATK: 15, DEF: 2, HP: 3, MOV: 8, RNG: 1, MOR: 10 }, special: ["Fearless", "Furious Charge (+2 ATK first turn)"] },
    { name: "Fragment Artillery Crew", faction: "emberclaw-warpack", points_cost: 3, role: "Support infantry", fragment_interactions: "Operates artillery", flavor_text: "Unbonded who operate fire-catapults", description: "Specialized unbonded warriors trained to operate the Warpack's crude but devastating fire-catapults and fragment-launchers. Unlike most Emberclaw fighters, these soldiers value precision over fury. They maintain and load the massive war machines that rain fire across the battlefield. Without them, the faction's artillery falls silent. Keep them protected — they're not fighters, but they multiply the destructive output of every War Machine in your army.", type: "Infantry", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 6, RNG: 1, MOR: 7 }, special: ["Operates War Machines", "Fragment Specialist"] },
    { name: "Reborn Phalanx", faction: "emberclaw-warpack", points_cost: 5, role: "Heavy infantry", fragment_interactions: "Phoenix buffs", flavor_text: "Warriors blessed by Flamewarden Kora", description: "Warriors blessed by Flamewarden Kora herself, who has breathed phoenix fire into their lungs. When a Reborn Phalanx soldier falls, there is a chance the phoenix fire ignites their body and reconstitutes them from the ashes — a miracle that has turned the tide of many battles. This heavy infantry unit anchors the Emberclaw battle line with stubbornness that borders on the supernatural. They fight in tight formation, each warrior knowing that death may not be permanent.", type: "Infantry", stats: { ATK: 12, DEF: 5, HP: 9, MOV: 6, RNG: 1, MOR: 9 }, special: ["Stubborn", "Phoenix Rebirth (50% chance to revive once)"] },
    { name: "Ashwalker Skirmishers", faction: "emberclaw-warpack", points_cost: 2, role: "Fast infantry", fragment_interactions: "Mobility buffs", flavor_text: "Light troops from the old nomadic clans", description: "Descended from the old nomadic clans that roamed the ash wastes before the Warpack consolidated, Ashwalker Skirmishers retain the hit-and-run tactics of their ancestors. Fast, lightly armored, and equipped with short-range fire-slings, they harass enemy flanks and bait charges into killing grounds. They excel at the skirmishing game but dissolve under direct assault. Their knowledge of ash-waste survival makes them natural scouts and flankers.", type: "Infantry", stats: { ATK: 6, DEF: 2, HP: 3, MOV: 9, RNG: 8, MOR: 6 }, special: ["Skirmish", "Retreat and Fire"] },
    { name: "Forge Acolytes", faction: "emberclaw-warpack", points_cost: 3, role: "Crafters", fragment_interactions: "Equipment creation", flavor_text: "Apprentice smiths who forge on the battlefield", description: "Apprentice smiths of the Ember Council who bring their craft directly to the battlefield. Armed with repair hammers and carrying pouches of fragment dust, Forge Acolytes can mend damaged armor and broken weapons mid-combat. They are invaluable support for sustained engagements, keeping War Machines and elite units in the fight longer than the enemy expects. Their fragment-forging abilities can occasionally produce improvised weapons or defensive wards on the spot.", type: "Infantry", stats: { ATK: 6, DEF: 3, HP: 3, MOV: 6, RNG: 1, MOR: 7 }, special: ["Field Repairs (heal 1 HP to adjacent units)", "Fragment Forging"] },
    { name: "Faithful Guard", faction: "emberclaw-warpack", points_cost: 3, role: "Morale support", fragment_interactions: "Divine buffs", flavor_text: "Devotees of the Crimson Tyrant's prophecies", description: "Fanatical devotees of the Crimson Tyrant's prophecies, the Faithful Guard fight with the unshakeable conviction that their cause is divinely mandated. Their unwavering morale inspires nearby warriors to fight harder, creating a zone of zealous determination around them. They serve as the moral backbone of any Emberclaw force, preventing the routs and panics that can cascade through less disciplined armies. Their faith is their shield — and they would sooner die than doubt.", type: "Infantry", stats: { ATK: 9, DEF: 4, HP: 6, MOV: 7, RNG: 1, MOR: 10 }, special: ["War Chant of Ash (+1 MOR aura; allies become Fire Resistant)", "Faithful"] },
    { name: "Scorched Veterans", faction: "emberclaw-warpack", points_cost: 5, role: "Elite core", fragment_interactions: "All buffs", flavor_text: "Survivors of a hundred battles", description: "The grizzled survivors of a hundred battles, Scorched Veterans have been burned so many times that their skin has become naturally fireproof. They fight with the calm efficiency of warriors who have seen everything and fear nothing. Their combat experience translates into superior accuracy (rerolling their worst attacks) and complete immunity to fire — both allied and enemy. They are the backbone elite of any serious Emberclaw army list, reliable in every situation.", type: "Infantry", stats: { ATK: 15, DEF: 5, HP: 9, MOV: 7, RNG: 1, MOR: 9 }, special: ["Veteran", "Fire Immune", "Reroll 1s"] },
    { name: "Ember Council Honor Guard", faction: "emberclaw-warpack", points_cost: 6, role: "Elite guard", fragment_interactions: "Command buffs", flavor_text: "Personal guards of the Council", description: "The personal fighting force of the Ember Council itself — the ruling body of the Warpack. These warriors are selected from the finest fighters across all clans and equipped with the best armor and weapons the faction produces. Each Honor Guard has survived at least three drake-bonding trials and carries fragment-enchanted weaponry. They serve as bodyguards to commanders and form an elite shock unit capable of standing against any opponent in close combat.", type: "Infantry", stats: { ATK: 18, DEF: 6, HP: 9, MOV: 7, RNG: 1, MOR: 10 }, special: ["Pyre Guardian (intercept attacks on commander; attacker catches fire)", "Fearless", "Flame Ward (+1 DEF; attackers take 1 fire damage)"] },
    { name: "Immolation Infantry", faction: "emberclaw-warpack", points_cost: 4, role: "Suicide troops", fragment_interactions: "Explosion on death", flavor_text: "Carry fire grenades; martyrdom is their weapon", description: "Warriors who have willingly accepted a death sentence in exchange for devastating effect. Each Immolation soldier carries multiple fire-grenades strapped to their body, ready to detonate on impact with the enemy — or on their own death. They charge forward with fearless abandon, knowing they are already dead. When they reach the enemy lines, the resulting explosion devastates everything in a wide radius. They are the Warpack's answer to fortified positions and densely-packed enemy formations.", type: "Infantry", stats: { ATK: 12, DEF: 3, HP: 3, MOV: 8, RNG: 8, MOR: 10 }, special: ["Fearless", "Death Explosion (3\" blast on death)"] },

    // CAVALRY (5 units)
    { name: "Ashrider Scouts", faction: "emberclaw-warpack", points_cost: 5, role: "Light cavalry", fragment_interactions: "Speed buffs", flavor_text: "Fast riders on unarmored drakes", description: "Fast riders mounted on young, unarmored drakes bred for speed rather than combat. Ashrider Scouts are the eyes of the Warpack, ranging far ahead of the main force to locate enemy positions, scout terrain, and identify ambush opportunities. Their drakes lack the armor and fire-breath of mature mounts, but compensate with extraordinary agility and climbing ability. They deploy ahead of the army and use their speed to stay alive — they're scouts, not fighters.", type: "Cavalry", stats: { ATK: 12, DEF: 3, HP: 6, MOV: 14, RNG: 6, MOR: 7 }, special: ["Ash Runner (deploy 6\" ahead; leave smoke trail)", "Fast"] },
    { name: "Skytalon Lancers", faction: "emberclaw-warpack", points_cost: 5, role: "Medium cavalry", fragment_interactions: "Charge buffs", flavor_text: "Young drake riders with flame lances", description: "Young drake riders equipped with the iconic flame lance — a long spear with a fragment-tipped head that ignites on impact. Skytalon Lancers perform devastating diving charges from altitude, striking with the combined force of their lance, their drake's mass, and the resulting fire explosion. The flame lance is a one-use weapon; after the initial charge, Lancers fight with conventional arms. They represent the classic Emberclaw tactical doctrine: hit hard from the sky, then overwhelm on the ground.", type: "Cavalry", stats: { ATK: 15, DEF: 4, HP: 9, MOV: 12, RNG: 4, MOR: 8 }, special: ["Fly", "Inferno Charge (+2 ATK on charge; creates burning terrain at impact)", "Fire Lance (one-use +4 ATK)"] },
    { name: "Emberknight Riders", faction: "emberclaw-warpack", points_cost: 8, role: "Heavy cavalry", fragment_interactions: "Elite buffs", flavor_text: "Mature drake riders in drake-scale armor", description: "The elite of the Emberclaw cavalry, Emberknights ride mature drakes in full drake-scale armor. The bond between rider and drake is so deep that they share wounds — damage to one is distributed between both. Their drakes possess the breath weapon that defines the Emberclaw: a cone of superheated fire that can incinerate infantry formations in seconds. Expensive, powerful, and iconic, Emberknight Riders are the premier hammer unit of the faction.", type: "Cavalry", stats: { ATK: 18, DEF: 5, HP: 12, MOV: 12, RNG: 4, MOR: 9 }, special: ["Fly", "Drake Bond (share wounds with drake)", "Breath Weapon (12\" cone)"] },
    { name: "Swift Talon Outriders", faction: "emberclaw-warpack", points_cost: 4, role: "Fast cavalry", fragment_interactions: "Mobility", flavor_text: "Extreme speed riders for harassment", description: "Extreme-speed cavalry mounted on drakes specifically bred for velocity. Swift Talon Outriders sacrifice armor and raw power for unmatched aerial mobility, capable of attacking and immediately disengaging before the enemy can respond. Their defensive flying patterns make them difficult targets for ranged attacks. They excel at hunting artillery, harassing supply lines, and chasing down fleeing units. If you need something done fast, Outriders are the answer.", type: "Cavalry", stats: { ATK: 12, DEF: 3, HP: 6, MOV: 14, RNG: 6, MOR: 8 }, special: ["Fly", "Scorch and Soar (attack then fly 6\" away; leave burning terrain behind)", "Evasion (+1 DEF vs ranged)"] },
    { name: "Scorchcaller Elites", faction: "emberclaw-warpack", points_cost: 10, role: "Elite cavalry", fragment_interactions: "All buffs", flavor_text: "Elite riders on Ancient drakes", description: "The pinnacle of Emberclaw cavalry — master riders bonded to Ancient-class drakes. These legendary beasts have lived for centuries, their fire burning hotter and their scales growing harder with age. The riders who earn an Ancient bond are among the most revered warriors in the Warpack. Their inferno breath covers enormous areas, their ancient resilience shrugs off the first wound they take, and their sheer presence terrifies enemy forces. They are walking win conditions.", type: "Cavalry", stats: { ATK: 21, DEF: 6, HP: 15, MOV: 12, RNG: 5, MOR: 10 }, special: ["Fly", "Drake Bond", "Inferno Breath (18\" cone)", "Ancient Resilience (ignore first wound)"] },

    // SUPPORT (8 units)
    { name: "Pyromancer Circle", faction: "emberclaw-warpack", points_cost: 5, role: "Magic support", fragment_interactions: "Spell casting", flavor_text: "Coordinated spellcasters", description: "A formation of coordinated spellcasters who combine their individual fire-channeling into devastating collective effects. Where a single Pyromancer throws fire bolts, a Circle summons fireballs — area-effect explosions that can break enemy formations apart. Their magic resistance protects them from fragment-based attacks, and their coordinated casting makes them the faction's premier magic-damage unit. Keep them protected; they're fragile but enormously destructive.", type: "Support", stats: { ATK: 9, DEF: 2, HP: 6, MOV: 7, RNG: 14, MOR: 7 }, special: ["Fireball (12\" blast)", "Fragment Manipulation", "Magic Resistance"] },
    { name: "Fragment Shapers", faction: "emberclaw-warpack", points_cost: 3, role: "Fragment specialists", fragment_interactions: "Enhance fragments", flavor_text: "Experts who stabilize or amplify fragments", description: "Specialists who understand fragments at a molecular level, capable of stabilizing volatile cores and amplifying their output. Fragment Shapers buff all nearby units that use fragment-based abilities, making them multiplier units that increase the effectiveness of the entire army. They carry no weapons of their own, relying on bodyguard units for protection. Position them in the center of your army for maximum buff coverage — they make good units great and great units terrifying.", type: "Support", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 6, RNG: 1, MOR: 7 }, special: ["Fragment Stabilization", "Buff Nearby Fragment Users"] },
    { name: "Flameheart Clerics", faction: "emberclaw-warpack", points_cost: 4, role: "Healers", fragment_interactions: "Healing", flavor_text: "Blessed by Kora's phoenix fire", description: "Blessed by Flamewarden Kora's phoenix fire, Flameheart Clerics channel healing flames that knit flesh and seal wounds. Unlike mundane healers, their phoenix-tinged mending also grants temporary fire resistance to the healed unit — a critical buff in a faction that creates burning terrain everywhere. They serve as the Warpack's combat medics, keeping elite units in the fight and recovering wounded heroes from the brink.", type: "Support", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 7, RNG: 8, MOR: 8 }, special: ["Phoenix Mend (restore 1d3 HP; healed unit gains Fire Resistant for 1 turn)", "Phoenix Blessing"] },
    { name: "Drake Handlers", faction: "emberclaw-warpack", points_cost: 3, role: "Beast support", fragment_interactions: "Drake buffs", flavor_text: "Tend and command unbonded drakes", description: "Specialists who focus on managing unbonded drakes on the battlefield. Drake Handlers prevent frenzied drakes from attacking friendly units and can issue basic commands to young drakes and fledgling swarms. They are essential support for any army fielding multiple drake War Machines, serving as the leash that keeps the Warpack's most powerful assets pointed at the enemy. Without them, unbonded drakes may rage out of control.", type: "Support", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 7, RNG: 1, MOR: 7 }, special: ["Command Drakes", "Calm Beast (prevent frenzy)"] },
    { name: "Embersmith Apprentices", faction: "emberclaw-warpack", points_cost: 3, role: "Equipment support", fragment_interactions: "Crafting", flavor_text: "Field smiths who repair and forge", description: "Field smiths who carry portable forges fueled by drake-fire. They can repair damaged equipment mid-battle and enchant weapons with a temporary fire bonus. Their weapon enhancement ability applies a flat +1 ATK to nearby friendly units, making them one of the most universally useful support options in the Emberclaw roster. Place them behind your front line and watch your entire army hit harder.", type: "Support", stats: { ATK: 6, DEF: 4, HP: 6, MOV: 6, RNG: 1, MOR: 7 }, special: ["Field Repairs", "Weapon Enhancement (+1 ATK to nearby units)"] },
    { name: "Smoke Weavers", faction: "emberclaw-warpack", points_cost: 3, role: "Concealment", fragment_interactions: "Smoke creation", flavor_text: "Create ash clouds for cover", description: "Specialists who collect and compress the thick ash that follows every Emberclaw army. Using specially-designed censer-launchers, they can hurl ash-cloud containers that explode into vision-blocking smoke screens. This allows the army to advance through killzones, cover retreats, and deny enemy ranged units their targets. Smoke Weavers are the tactical utility unit every Emberclaw general needs — cheap, effective, and capable of reshaping sightlines.", type: "Support", stats: { ATK: 6, DEF: 2, HP: 3, MOV: 7, RNG: 10, MOR: 6 }, special: ["Smoke Screen (block LoS)", "Cover Provider"] },
    { name: "Divine Acolytes", faction: "emberclaw-warpack", points_cost: 4, role: "Morale support", fragment_interactions: "Divine buffs", flavor_text: "Prophets who channel the Tyrant's voice", description: "Prophets who channel the voice of the Crimson Tyrant — the legendary figure at the heart of Emberclaw faith. Their inspiring presence bolsters nearby morale, and their prophetic abilities grant allied units the chance to reroll failed dice. They serve as force multipliers, turning close combats from coin-flips into favorable odds. The visions they receive are not always accurate, but the confidence they inspire is always real.", type: "Support", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 7, RNG: 1, MOR: 9 }, special: ["War Chant of Ash (+1 MOR aura; allies become Fire Resistant)", "Prophecy (reroll one die per turn)"] },
    { name: "Bonfire Keepers", faction: "emberclaw-warpack", points_cost: 3, role: "Area denial", fragment_interactions: "Terrain modification", flavor_text: "Maintain burning zones on the battlefield", description: "Specialists who maintain permanent burning zones on the battlefield, creating obstacles and hazards for non-fire-resistant enemies. They carry alchemical fire mixtures that can ignite terrain on command, turning open ground into impassable infernos. For a faction that thrives in fire, Bonfire Keepers are the unit that reshapes the entire battlefield to favor Emberclaw movement and deny it to the enemy.", type: "Support", stats: { ATK: 6, DEF: 3, HP: 6, MOV: 6, RNG: 8, MOR: 7 }, special: ["Create Burning Terrain", "Fire Immune"] },

    // SCOUTS (3 units)
    { name: "Silent Wing Scouts", faction: "emberclaw-warpack", points_cost: 3, role: "Reconnaissance", fragment_interactions: "Vision", flavor_text: "Stealth drake riders", description: "The Warpack's premier reconnaissance unit — stealth drake riders who fly high and quiet, observing enemy positions without being detected. Their small, dark-scaled drakes are bred specifically for silence, lacking the roaring fire-breath of their larger cousins. Silent Wing Scouts deploy ahead of the army and provide intelligence that shapes the entire battle plan. They can attack opportunistically, but their real value is information.", type: "Scout", stats: { ATK: 9, DEF: 2, HP: 6, MOV: 14, RNG: 8, MOR: 7 }, special: ["Fly", "Smoke Veil (hidden in ash/smoke terrain; revealed only when attacking)", "Ash Runner (deploy 6\" ahead; leave smoke trail)", "Forward Deploy"] },
    { name: "Thermal Trackers", faction: "emberclaw-warpack", points_cost: 3, role: "Spotters", fragment_interactions: "Detection", flavor_text: "Sense heat signatures from miles away", description: "Ground-based scouts who use fragment-enhanced thermal vision to detect heat signatures through terrain, smoke, and darkness. They cannot be fooled by stealth or concealment that relies on visual deception — if it generates heat, Thermal Trackers can see it. They serve as the hard counter to enemy stealth units and provide targeting data for allied artillery. Their own combat capability is minimal; their value is entirely in detection.", type: "Scout", stats: { ATK: 6, DEF: 2, HP: 3, MOV: 8, RNG: 10, MOR: 6 }, special: ["Detect Hidden Units", "Thermal Vision"] },
    { name: "Sky Watchers", faction: "emberclaw-warpack", points_cost: 4, role: "Intel gathering", fragment_interactions: "Information", flavor_text: "Observe everything from altitude", description: "High-altitude observers mounted on drakes trained to circle above the battlefield at extreme height. From their vantage point, Sky Watchers can see everything — enemy formations, hidden units, reinforcement routes, and flanking attempts. They relay this intelligence to ground commanders, extending the effective command range of the entire army. Their elevated position also makes them formidable ranged platforms, able to fire down into enemy formations with impunity.", type: "Scout", stats: { ATK: 9, DEF: 3, HP: 6, MOV: 12, RNG: 14, MOR: 8 }, special: ["Fly", "Perfect Vision", "Relay Commands"] },

    // ARTILLERY (3 units)
    { name: "Pyroclast Catapult", faction: "emberclaw-warpack", points_cost: 6, role: "Siege artillery", fragment_interactions: "Fire ammo", flavor_text: "Launches burning oil and fragments", description: "A massive siege weapon that launches containers of burning oil and fragment shards in high arcs. The Pyroclast Catapult can hit targets behind cover and walls, and its projectiles create zones of burning terrain on impact. It is the backbone of Emberclaw siege warfare — slow, immobile once deployed, but capable of destroying fortifications and incinerating packed infantry formations. Keep it protected behind your lines and let it rain fire.", type: "Artillery", stats: { ATK: 18, DEF: 3, HP: 9, MOV: 5, RNG: 26, MOR: 7 }, special: ["Indirect Fire", "Blast Template", "Creates Burning Terrain"] },
    { name: "Fragment Launcher", faction: "emberclaw-warpack", points_cost: 7, role: "Magic artillery", fragment_interactions: "Fragment ammo", flavor_text: "Fires explosive fragments at range", description: "The most destructive conventional weapon in the Emberclaw arsenal — a massive launcher that fires unstable fragment cores at extreme range. The cores detonate on impact with variable and often spectacular effects: firestorms, shockwaves, or reality-warping explosions. The Fragment Launcher's power comes with unpredictability; each shot is different, making it as exciting as it is devastating. It has the longest range of any Emberclaw weapon.", type: "Artillery", stats: { ATK: 21, DEF: 3, HP: 9, MOV: 5, RNG: 32, MOR: 7 }, special: ["Indirect Fire", "Fragment Detonation", "Variable Effect"] },
    { name: "Ember Ballista", faction: "emberclaw-warpack", points_cost: 5, role: "Anti-air", fragment_interactions: "Precision shots", flavor_text: "Designed to bring down drakes and flyers", description: "Originally designed to bring down enemy drakes and flying units, the Ember Ballista fires superheated bolts with pinpoint accuracy. Each bolt is tipped with a fragment shard that penetrates armor and continues burning through internal structures. While it's primarily anti-air, its armor-piercing capability makes it effective against any heavily-armored target. A reliable and cost-effective artillery piece.", type: "Artillery", stats: { ATK: 12, DEF: 3, HP: 9, MOV: 5, RNG: 26, MOR: 7 }, special: ["Anti-Air", "Armor Piercing"] },

    // SPECIALIST (5 units)
    { name: "Fledgling Swarm", faction: "emberclaw-warpack", points_cost: 3, role: "Cheap flyers", fragment_interactions: "Growth", flavor_text: "Young drakes not yet bonded", description: "Young drakes not yet old enough for bonding, released in chaotic swarms. Individually weak, Fledgling Swarms overwhelm through sheer numbers, pecking, clawing, and breathing sparks in all directions. They count as a single unit despite comprising multiple creatures, making them point-efficient disposable damage. Their real value is as a screen and area-denial tool — enemies must deal with the swarm or be perpetually harassed by flying pests.", type: "Specialist", stats: { ATK: 6, DEF: 2, HP: 3, MOV: 12, RNG: 1, MOR: 6 }, special: ["Fly", "Swarm (multiple count as one unit)", "Spark Breath (6\" weak fire)"] },
    { name: "Immolation Bombers", faction: "emberclaw-warpack", points_cost: 4, role: "Suicide unit", fragment_interactions: "Explosion", flavor_text: "Riders who dive into enemies and detonate", description: "The most terrifying unit in the Emberclaw arsenal — riders on small, fast drakes packed with volatile fragment charges. They dive at full speed into the enemy and detonate, destroying themselves in a massive explosion that devastates everything nearby. The riders are volunteers who have accepted martyrdom for the glory of the Warpack. There is no defense against a committed Immolation Bomber except to kill it before it reaches you. Use them to crack open fortified positions.", type: "Specialist", stats: { ATK: 18, DEF: 2, HP: 3, MOV: 14, RNG: 1, MOR: 10 }, special: ["Fly", "Fearless", "Kamikaze (6\" blast on contact, unit dies)"] },
    { name: "Phoenix Guard", faction: "emberclaw-warpack", points_cost: 6, role: "Resurrection", fragment_interactions: "Rebirth", flavor_text: "Warriors who rise from their ashes", description: "Warriors who have been touched by true phoenix fire and carry its spark within their bodies. When a Phoenix Guard falls in battle, the spark ignites and reconstitutes them from their own ashes — a guaranteed resurrection that makes them extraordinarily resilient. They fight with the confidence of immortals, inspiring nearby allies with the knowledge that death is not the end. They are expensive but nearly impossible to remove permanently from the board.", type: "Specialist", stats: { ATK: 15, DEF: 4, HP: 6, MOV: 7, RNG: 1, MOR: 10 }, special: ["Phoenix Rebirth (auto-revive once)", "Fire Immune", "Ember Inspiration (allies within 6\" gain Fire Resistant and +1 MOR)"] },
    { name: "Fragment-Blade Assassins", faction: "emberclaw-warpack", points_cost: 5, role: "Assassins", fragment_interactions: "Stealth kills", flavor_text: "Unbonded killers with fragment daggers", description: "Unbonded killers equipped with daggers made from raw, unstabilized fragment crystal. These weapons bypass conventional armor entirely, phasing through physical defenses to strike directly at flesh. Fragment-Blade Assassins operate alone, using concealment to approach enemy commanders and eliminate them with a single devastating strike. They are glass cannons — if they reach their target, the target dies; if they're detected early, they die instead.", type: "Specialist", stats: { ATK: 18, DEF: 3, HP: 6, MOV: 9, RNG: 1, MOR: 8 }, special: ["Smoke Veil (hidden in ash/smoke terrain; revealed only when attacking)", "Dragonfire Strike (+3 ATK vs commanders; target catches fire)", "Fragment Blade (ignore armor)"] },
    { name: "Flame Prophets", faction: "emberclaw-warpack", points_cost: 5, role: "Morale warfare", fragment_interactions: "Prophecy", flavor_text: "Madmen who see the future in flames", description: "Half-mad seers who stare into flames until they see fragments of the future. Their prophecies are unreliable but their battlefield presence is undeniable — they grant nearby allies the ability to reroll dice (the prophet having 'seen' a better outcome), and their maddening screams of future horrors impose severe morale penalties on enemy units. Flame Prophets are psychological warfare incarnate, breaking enemy resolve while bolstering allied conviction.", type: "Specialist", stats: { ATK: 9, DEF: 2, HP: 6, MOV: 7, RNG: 14, MOR: 10 }, special: ["Prophecy (grant rerolls)", "Terror", "Maddening Visions (enemy morale penalty)"] },

    // WAR MACHINES (11 units)
    { name: "Grounded Wyrm", faction: "emberclaw-warpack", points_cost: 110, role: "Super-heavy", fragment_interactions: "Massive fire", flavor_text: "Ancient drake too old to fly", description: "An ancient drake of immense size, too old and heavy to fly but far too powerful to leave behind. Grounded Wyrms are living siege engines — their massive bodies crush fortifications, their cataclysmic breath weapons devastate entire flanks, and their earthquake-inducing stomps send shockwaves through enemy formations. They are slow, but nothing short of concentrated army-wide firepower can bring one down. A Grounded Wyrm IS the battle plan.", type: "War Machine", stats: { ATK: 27, DEF: 7, HP: 36, MOV: 6, RNG: 5, MOR: 10 }, special: ["Massive", "Cataclysm Breath (24\" cone)", "Earthquake Stomp (AoE melee)"] },
    { name: "Mature War Drake", faction: "emberclaw-warpack", points_cost: 80, role: "Heavy monster", fragment_interactions: "Breath weapon", flavor_text: "Prime-age drake in full power", description: "A drake in its prime of life — big enough to devastate infantry, fast enough to fly across the battlefield, and temperamental enough to terrify everything in its path. The Mature War Drake is the quintessential Emberclaw War Machine: it breathes fire in wide cones, tears through armor with rending claws, and its presence alone forces enemy morale checks. It represents the peak balance of power, speed, and durability in the faction's drake lineup.", type: "War Machine", stats: { ATK: 21, DEF: 5, HP: 24, MOV: 12, RNG: 4, MOR: 9 }, special: ["Fly", "Inferno Breath (18\" cone)", "Rending Claws", "Terror"] },
    { name: "Young War Drake", faction: "emberclaw-warpack", points_cost: 60, role: "Medium monster", fragment_interactions: "Fire attacks", flavor_text: "Adolescent drake with volatile fire", description: "An adolescent drake with explosive speed and volatile, hard-to-control fire. Young War Drakes are faster than their mature counterparts but lack the armor and raw destructive power. Their flame breath is shorter-ranged but still devastating, and their diving attacks from altitude hit with tremendous force. They excel at hit-and-run tactics, swooping in to devastate a target before climbing back to safety. Their unpredictability makes them exciting battlefield additions.", type: "War Machine", stats: { ATK: 18, DEF: 4, HP: 18, MOV: 14, RNG: 4, MOR: 8 }, special: ["Fly", "Flame Breath (12\" cone)", "Dive Attack (+2 ATK from altitude)"] },
    { name: "Fire Colossus", faction: "emberclaw-warpack", points_cost: 90, role: "Construct", fragment_interactions: "Fragment powered", flavor_text: "Massive golem animated by fragments", description: "A massive golem animated by a fragment core lodged in its chest. The Fire Colossus is an artificial war machine of staggering power — immune to morale, wreathed in a damaging fire aura, and carrying a fragment core that detonates spectacularly when the construct is finally destroyed. It leaves no safe distance; enemies near it take fire damage, and enemies who destroy it take explosion damage. It's a walking liability for the enemy.", type: "War Machine", stats: { ATK: 24, DEF: 6, HP: 30, MOV: 7, RNG: 8, MOR: 10 }, special: ["Fearless", "Fragment Core (explodes on death)", "Fire Aura (damages nearby enemies)"] },
    { name: "Magma Titan", faction: "emberclaw-warpack", points_cost: 95, role: "Elemental", fragment_interactions: "Lava creation", flavor_text: "Living magma bound to combat", description: "A bound elemental of living magma — the product of the Warpack's most dangerous fragment rituals. The Magma Titan oozes across the battlefield leaving trails of lava in its wake, literally reshaping the terrain into a hellscape. Its magma blasts can hit at medium range, and its fire immunity makes it a perfect anchor in the burning terrain it creates. Slow but inexorable, the Magma Titan turns the entire board into Emberclaw-favored ground.", type: "War Machine", stats: { ATK: 24, DEF: 5, HP: 33, MOV: 6, RNG: 10, MOR: 10 }, special: ["Fire Immune", "Creates Lava Terrain", "Magma Blast"] },
    { name: "Drake Nest Mobile", faction: "emberclaw-warpack", points_cost: 70, role: "Spawner", fragment_interactions: "Summons drakes", flavor_text: "Portable hatchery on wheels", description: "A portable hatchery mounted on a reinforced wagon, continuously spawning fledgling drakes that swarm out to harass the enemy. The Drake Nest Mobile is the ultimate attrition tool — as long as it lives, it produces a steady stream of expendable flying units every turn. It's slow and vulnerable to focused fire, but protecting it pays dividends over a long game. Park it behind your lines and let it flood the board with baby drakes.", type: "War Machine", stats: { ATK: 12, DEF: 6, HP: 24, MOV: 5, RNG: 1, MOR: 10 }, special: ["Spawn Fledglings (1d3 per turn)", "Heavily Armored", "Slow"] },
    { name: "Obsidax (Unique Wyrm)", faction: "emberclaw-warpack", points_cost: 200, role: "Named monster", fragment_interactions: "Legendary", flavor_text: "Tzarak's Obsidian Wyrm partner", description: "Tzarak's legendary partner — an Obsidian Wyrm of catastrophic power. Obsidax is the single most devastating unit in the entire Emberclaw roster, rivaling small armies in raw destructive output. Its cataclysmic breath weapon covers an absurd area, its mere landing creates earthquakes, and its ancient, obsidian-hard scales shrug off hits that would fell lesser drakes. Fielding Obsidax is a statement: this game will end violently. Unique to Tzarak's army only.", type: "War Machine", stats: { ATK: 42, DEF: 9, HP: 72, MOV: 12, RNG: 8, MOR: 10 }, special: ["Fly", "Cataclysm Breath (30\" cone)", "Ancient Power", "Earthquake Landing", "Legendary (one per army)"] },
    { name: "Pyrathax (Unique Ancient)", faction: "emberclaw-warpack", points_cost: 150, role: "Named drake", fragment_interactions: "Commander mount", flavor_text: "Scorchcaller Vex's drake", description: "Scorchcaller Vex's bonded drake — an Ancient-class beast of terrifying speed and devastating crimson fire-breath. Pyrathax is faster than any drake its size should be, capable of crossing the battlefield in a single turn to deliver its signature Crimson Inferno Breath where it will do the most damage. Its ancient resilience means it shrugs off the first wound it takes. Pyrathax represents Vex's personal philosophy: speed is the ultimate weapon.", type: "War Machine", stats: { ATK: 30, DEF: 7, HP: 48, MOV: 14, RNG: 6, MOR: 10 }, special: ["Fly", "Crimson Inferno Breath (20\" cone)", "Ancient Resilience", "Legendary (Vex only)"] },
    { name: "Flame Engine", faction: "emberclaw-warpack", points_cost: 65, role: "Support war machine", fragment_interactions: "Buff aura", flavor_text: "Mobile fragment reactor", description: "A mobile fragment reactor mounted on a reinforced platform, the Flame Engine amplifies the fire-based abilities of every unit in its radius. It turns mediocre fire attacks into devastating ones and mediocre units into fire-powered threats. The reactor core is fragile — if the Engine is destroyed, the core's rupture is dangerous. Keep the Flame Engine in the center of your army where its buff aura covers the most units, and protect it at all costs.", type: "War Machine", stats: { ATK: 12, DEF: 5, HP: 21, MOV: 6, RNG: 1, MOR: 10 }, special: ["Fragment Amplification Aura", "Buff Nearby Fire Attacks", "Fragile Core"] },
    { name: "Cinder Golem", faction: "emberclaw-warpack", points_cost: 70, role: "Animated construct", fragment_interactions: "Ash creation", flavor_text: "Golem made from volcanic ash", description: "A construct animated from compacted volcanic ash and held together by fragment energy. The Cinder Golem fights with mindless determination, regenerating its ash-body from surrounding terrain. Its ash cloud aura blocks line of sight to units behind it, making it an excellent moving wall. In ash terrain, it regenerates aggressively, becoming nearly impossible to destroy. The Golem is a versatile war machine — part tank, part terrain blocker, part regenerating wall of ash.", type: "War Machine", stats: { ATK: 21, DEF: 6, HP: 27, MOV: 7, RNG: 1, MOR: 10 }, special: ["Fearless", "Regeneration (in ash terrain)", "Ash Cloud Aura (blocks LoS)"] },
    { name: "Scorched Titan", faction: "emberclaw-warpack", points_cost: 100, role: "Heavy construct", fragment_interactions: "Demolition", flavor_text: "Massive stone giant wreathed in flame", description: "The largest construct in the Emberclaw arsenal — a massive stone giant wreathed in perpetual flame. The Scorched Titan was originally a mining golem repurposed for war, and its siege-breaking capabilities reflect that origin. It can demolish fortifications with contemptuous ease, stomp infantry flat with area-effect attacks, and simply walk through obstacles that would stop lesser units. It is slow, but it is unstoppable — nothing short of massed anti-armor fire will halt its advance.", type: "War Machine", stats: { ATK: 27, DEF: 7, HP: 36, MOV: 6, RNG: 4, MOR: 10 }, special: ["Massive", "Siege Breaker", "Fire Stomp (AoE)", "Slow but Unstoppable"] }
  );
