(function() {
  ...
  gameData.commanders.push(
    {
      ...
      base_stats: { Command: 9, Knowledge: 7, Leadership: 8, Agility: 7, Health: 95 },
      battle_stats: { ATK: 6, DEF: 5, HP: 11, MOV: 10, RNG: 2, MOR: 9 },
      points_cost: 24,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 10, Leadership: 9, Agility: 6, Health: 70 },
      battle_stats: { ATK: 4, DEF: 3, HP: 8, MOV: 6, RNG: 8, MOR: 10 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 6, Knowledge: 9, Leadership: 5, Agility: 8, Health: 85 },
      battle_stats: { ATK: 5, DEF: 4, HP: 9, MOV: 5, RNG: 10, MOR: 7 },
      points_cost: 18,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 6, Leadership: 10, Agility: 4, Health: 150 },
      battle_stats: { ATK: 9, DEF: 7, HP: 15, MOV: 8, RNG: 3, MOR: 10 },
      points_cost: 35,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 5, Leadership: 6, Agility: 10, Health: 80 },
      battle_stats: { ATK: 5, DEF: 3, HP: 7, MOV: 14, RNG: 4, MOR: 8 },
      points_cost: 19,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 10, Leadership: 7, Agility: 5, Health: 90 },
      battle_stats: { ATK: 4, DEF: 5, HP: 10, MOV: 4, RNG: 6, MOR: 9 },
      points_cost: 22,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 5, Knowledge: 4, Leadership: 6, Agility: 9, Health: 100 },
      battle_stats: { ATK: 8, DEF: 4, HP: 12, MOV: 7, RNG: 1, MOR: 10 },
      points_cost: 21,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 10, Leadership: 7, Agility: 8, Health: 75 },
      battle_stats: { ATK: 4, DEF: 3, HP: 8, MOV: 10, RNG: 8, MOR: 8 },
      points_cost: 17,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 8, Leadership: 9, Agility: 6, Health: 90 },
      battle_stats: { ATK: 5, DEF: 5, HP: 10, MOV: 6, RNG: 4, MOR: 9 },
      points_cost: 20,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 6, Knowledge: 5, Leadership: 7, Agility: 5, Health: 110 },
      battle_stats: { ATK: 7, DEF: 6, HP: 13, MOV: 5, RNG: 2, MOR: 9 },
      points_cost: 23,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 8, Knowledge: 10, Leadership: 10, Agility: 5, Health: 70 },
      battle_stats: { ATK: 3, DEF: 4, HP: 9, MOV: 5, RNG: 12, MOR: 10 },
      points_cost: 22,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 7, Knowledge: 5, Leadership: 8, Agility: 7, Health: 105 },
      battle_stats: { ATK: 8, DEF: 5, HP: 12, MOV: 8, RNG: 1, MOR: 10 },
      points_cost: 24,
      level_1_deck: {
...

    {
      ...
      base_stats: { Command: 6, Knowledge: 10, Leadership: 5, Agility: 6, Health: 80 },
      battle_stats: { ATK: 5, DEF: 3, HP: 9, MOV: 8, RNG: 10, MOR: 7 },
      points_cost: 21,
      level_1_deck: {
  ...
  gameData.units.push(
    // INFANTRY (15 units)
    { name: "Ashborn Infantry", faction: "emberclaw-warpack", points_cost: 1, role: "Core troops", fragment_interactions: "Minor fire buffs", flavor_text: "Unbonded warriors wielding flame-forged spears", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 1, MOV: 5, RNG: 1, MOR: 6 }, special: ["Fire Resistant"] },
    { name: "Emberclaw Warriors", faction: "emberclaw-warpack", points_cost: 2, role: "Standard infantry", fragment_interactions: "Fire buffs", flavor_text: "Standard ground troops with javelin and shield", type: "Infantry", stats: { ATK: 3, DEF: 3, HP: 1, MOV: 5, RNG: 4, MOR: 7 }, special: ["Fire Resistant", "Javelin Thrower"] },
    { name: "Flameborn Guard", faction: "emberclaw-warpack", points_cost: 3, role: "Elite infantry", fragment_interactions: "Strong fire synergy", flavor_text: "Veterans who have survived the Branding", type: "Infantry", stats: { ATK: 4, DEF: 4, HP: 2, MOV: 5, RNG: 1, MOR: 8 }, special: ["Fire Resistant", "Shield Wall", "Drakeblood Fury (+1 ATK when wounded)"] },
    { name: "Pyromancer Adepts", faction: "emberclaw-warpack", points_cost: 3, role: "Magic infantry", fragment_interactions: "Cast fire spells", flavor_text: "Unbonded warriors who channel flame", type: "Infantry", stats: { ATK: 3, DEF: 2, HP: 1, MOV: 5, RNG: 8, MOR: 7 }, special: ["Fire Bolt (8\" RNG fire attack)", "Fragment User"] },
    { name: "Emberforged Blades", faction: "emberclaw-warpack", points_cost: 4, role: "Melee specialists", fragment_interactions: "Weapon buffs", flavor_text: "Elite warriors with fragment-infused swords", type: "Infantry", stats: { ATK: 5, DEF: 4, HP: 2, MOV: 6, RNG: 1, MOR: 8 }, special: ["Flame Weapons (ignore 1 DEF)", "Counterattack"] },
    { name: "Hatchery Guard", faction: "emberclaw-warpack", points_cost: 2, role: "Defensive infantry", fragment_interactions: "Defensive buffs", flavor_text: "Protectors of the sacred clutches", type: "Infantry", stats: { ATK: 3, DEF: 5, HP: 2, MOV: 4, RNG: 1, MOR: 9 }, special: ["Stubborn", "Hold Ground (+2 DEF if not moving)"] },
    { name: "Unbonded Berserkers", faction: "emberclaw-warpack", points_cost: 3, role: "Shock troops", fragment_interactions: "Fury buffs", flavor_text: "Warriors seeking death with honor", type: "Infantry", stats: { ATK: 5, DEF: 2, HP: 1, MOV: 6, RNG: 1, MOR: 10 }, special: ["Fearless", "Furious Charge (+2 ATK first turn)"] },
    { name: "Fragment Artillery Crew", faction: "emberclaw-warpack", points_cost: 4, role: "Support infantry", fragment_interactions: "Operates artillery", flavor_text: "Unbonded who operate fire-catapults", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 4, RNG: 1, MOR: 7 }, special: ["Operates War Machines", "Fragment Specialist"] },
    { name: "Reborn Phalanx", faction: "emberclaw-warpack", points_cost: 5, role: "Heavy infantry", fragment_interactions: "Phoenix buffs", flavor_text: "Warriors blessed by Flamewarden Kora", type: "Infantry", stats: { ATK: 4, DEF: 5, HP: 3, MOV: 4, RNG: 1, MOR: 9 }, special: ["Stubborn", "Phoenix Rebirth (50% chance to revive once)"] },
    { name: "Ashwalker Skirmishers", faction: "emberclaw-warpack", points_cost: 2, role: "Fast infantry", fragment_interactions: "Mobility buffs", flavor_text: "Light troops from the old nomadic clans", type: "Infantry", stats: { ATK: 3, DEF: 2, HP: 1, MOV: 7, RNG: 6, MOR: 6 }, special: ["Skirmish", "Retreat and Fire"] },
    { name: "Forge Acolytes", faction: "emberclaw-warpack", points_cost: 3, role: "Crafters", fragment_interactions: "Equipment creation", flavor_text: "Apprentice smiths who forge on the battlefield", type: "Infantry", stats: { ATK: 2, DEF: 3, HP: 1, MOV: 4, RNG: 1, MOR: 7 }, special: ["Field Repairs (heal 1 HP to adjacent units)", "Fragment Forging"] },
    { name: "Faithful Guard", faction: "emberclaw-warpack", points_cost: 3, role: "Morale support", fragment_interactions: "Divine buffs", flavor_text: "Devotees of the Crimson Tyrant's prophecies", type: "Infantry", stats: { ATK: 3, DEF: 4, HP: 2, MOV: 5, RNG: 1, MOR: 10 }, special: ["Inspiring Presence (+1 MOR to nearby allies)", "Faithful"] },
    { name: "Scorched Veterans", faction: "emberclaw-warpack", points_cost: 5, role: "Elite core", fragment_interactions: "All buffs", flavor_text: "Survivors of a hundred battles", type: "Infantry", stats: { ATK: 5, DEF: 5, HP: 3, MOV: 5, RNG: 1, MOR: 9 }, special: ["Veteran", "Fire Immune", "Reroll 1s"] },
    { name: "Ember Council Honor Guard", faction: "emberclaw-warpack", points_cost: 6, role: "Elite guard", fragment_interactions: "Command buffs", flavor_text: "Personal guards of the Council", type: "Infantry", stats: { ATK: 6, DEF: 6, HP: 3, MOV: 5, RNG: 1, MOR: 10 }, special: ["Bodyguard", "Fearless", "Shield Wall"] },
    { name: "Immolation Infantry", faction: "emberclaw-warpack", points_cost: 4, role: "Suicide troops", fragment_interactions: "Explosion on death", flavor_text: "Carry fire grenades; martyrdom is their weapon", type: "Infantry", stats: { ATK: 4, DEF: 3, HP: 1, MOV: 6, RNG: 6, MOR: 10 }, special: ["Fearless", "Death Explosion (3\" blast on death)"] },

    // CAVALRY (5 units)
    { name: "Ashrider Scouts", faction: "emberclaw-warpack", points_cost: 3, role: "Light cavalry", fragment_interactions: "Speed buffs", flavor_text: "Fast riders on unarmored drakes", type: "Cavalry", stats: { ATK: 4, DEF: 3, HP: 2, MOV: 12, RNG: 4, MOR: 7 }, special: ["Scout", "Fast"] },
    { name: "Skytalon Lancers", faction: "emberclaw-warpack", points_cost: 5, role: "Medium cavalry", fragment_interactions: "Charge buffs", flavor_text: "Young drake riders with flame lances", type: "Cavalry", stats: { ATK: 5, DEF: 4, HP: 3, MOV: 10, RNG: 2, MOR: 8 }, special: ["Flying", "Charge (+2 ATK)", "Fire Lance (one-use +4 ATK)"] },
    { name: "Emberknight Riders", faction: "emberclaw-warpack", points_cost: 8, role: "Heavy cavalry", fragment_interactions: "Elite buffs", flavor_text: "Mature drake riders in drake-scale armor", type: "Cavalry", stats: { ATK: 6, DEF: 5, HP: 4, MOV: 10, RNG: 2, MOR: 9 }, special: ["Flying", "Drake Bond (share wounds with drake)", "Breath Weapon (12\" cone)"] },
    { name: "Swift Talon Outriders", faction: "emberclaw-warpack", points_cost: 4, role: "Fast cavalry", fragment_interactions: "Mobility", flavor_text: "Extreme speed riders for harassment", type: "Cavalry", stats: { ATK: 4, DEF: 3, HP: 2, MOV: 14, RNG: 4, MOR: 8 }, special: ["Flying", "Hit and Run", "Evasion (+1 DEF vs ranged)"] },
    { name: "Scorchcaller Elites", faction: "emberclaw-warpack", points_cost: 10, role: "Elite cavalry", fragment_interactions: "All buffs", flavor_text: "Elite riders on Ancient drakes", type: "Cavalry", stats: { ATK: 7, DEF: 6, HP: 5, MOV: 10, RNG: 3, MOR: 10 }, special: ["Flying", "Drake Bond", "Inferno Breath (18\" cone)", "Ancient Resilience (ignore first wound)"] },

    // SUPPORT (8 units)
    { name: "Pyromancer Circle", faction: "emberclaw-warpack", points_cost: 5, role: "Magic support", fragment_interactions: "Spell casting", flavor_text: "Coordinated spellcasters", type: "Support", stats: { ATK: 3, DEF: 2, HP: 2, MOV: 5, RNG: 12, MOR: 7 }, special: ["Fireball (12\" blast)", "Fragment Manipulation", "Magic Resistance"] },
    { name: "Fragment Shapers", faction: "emberclaw-warpack", points_cost: 4, role: "Fragment specialists", fragment_interactions: "Enhance fragments", flavor_text: "Experts who stabilize or amplify fragments", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 4, RNG: 1, MOR: 7 }, special: ["Fragment Stabilization", "Buff Nearby Fragment Users"] },
    { name: "Flameheart Clerics", faction: "emberclaw-warpack", points_cost: 4, role: "Healers", fragment_interactions: "Healing", flavor_text: "Blessed by Kora's phoenix fire", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 6, MOR: 8 }, special: ["Heal (restore 1d3 HP)", "Phoenix Blessing"] },
    { name: "Drake Handlers", faction: "emberclaw-warpack", points_cost: 3, role: "Beast support", fragment_interactions: "Drake buffs", flavor_text: "Tend and command unbonded drakes", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 7 }, special: ["Command Drakes", "Calm Beast (prevent frenzy)"] },
    { name: "Embersmith Apprentices", faction: "emberclaw-warpack", points_cost: 4, role: "Equipment support", fragment_interactions: "Crafting", flavor_text: "Field smiths who repair and forge", type: "Support", stats: { ATK: 2, DEF: 4, HP: 2, MOV: 4, RNG: 1, MOR: 7 }, special: ["Field Repairs", "Weapon Enhancement (+1 ATK to nearby units)"] },
    { name: "Smoke Weavers", faction: "emberclaw-warpack", points_cost: 3, role: "Concealment", fragment_interactions: "Smoke creation", flavor_text: "Create ash clouds for cover", type: "Support", stats: { ATK: 2, DEF: 2, HP: 1, MOV: 5, RNG: 8, MOR: 6 }, special: ["Smoke Screen (block LoS)", "Cover Provider"] },
    { name: "Divine Acolytes", faction: "emberclaw-warpack", points_cost: 4, role: "Morale support", fragment_interactions: "Divine buffs", flavor_text: "Prophets who channel the Tyrant's voice", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 5, RNG: 1, MOR: 9 }, special: ["Inspiring Presence", "Prophecy (reroll one die per turn)"] },
    { name: "Bonfire Keepers", faction: "emberclaw-warpack", points_cost: 3, role: "Area denial", fragment_interactions: "Terrain modification", flavor_text: "Maintain burning zones on the battlefield", type: "Support", stats: { ATK: 2, DEF: 3, HP: 2, MOV: 4, RNG: 6, MOR: 7 }, special: ["Create Burning Terrain", "Fire Immunity"] },

    // SCOUTS (3 units)
    { name: "Silent Wing Scouts", faction: "emberclaw-warpack", points_cost: 3, role: "Reconnaissance", fragment_interactions: "Vision", flavor_text: "Stealth drake riders", type: "Scout", stats: { ATK: 3, DEF: 2, HP: 2, MOV: 12, RNG: 6, MOR: 7 }, special: ["Flying", "Stealth", "Scout", "Forward Deploy"] },
    { name: "Thermal Trackers", faction: "emberclaw-warpack", points_cost: 2, role: "Spotters", fragment_interactions: "Detection", flavor_text: "Sense heat signatures from miles away", type: "Scout", stats: { ATK: 2, DEF: 2, HP: 1, MOV: 6, RNG: 8, MOR: 6 }, special: ["Detect Hidden Units", "Thermal Vision"] },
    { name: "Sky Watchers", faction: "emberclaw-warpack", points_cost: 4, role: "Intel gathering", fragment_interactions: "Information", flavor_text: "Observe everything from altitude", type: "Scout", stats: { ATK: 3, DEF: 3, HP: 2, MOV: 10, RNG: 12, MOR: 8 }, special: ["Flying", "Perfect Vision", "Relay Commands"] },

    // ARTILLERY (3 units)
    { name: "Pyroclast Catapult", faction: "emberclaw-warpack", points_cost: 6, role: "Siege artillery", fragment_interactions: "Fire ammo", flavor_text: "Launches burning oil and fragments", type: "Artillery", stats: { ATK: 6, DEF: 3, HP: 3, MOV: 3, RNG: 24, MOR: 7 }, special: ["Indirect Fire", "Blast Template", "Creates Burning Terrain"] },
    { name: "Fragment Launcher", faction: "emberclaw-warpack", points_cost: 7, role: "Magic artillery", fragment_interactions: "Fragment ammo", flavor_text: "Fires explosive fragments at range", type: "Artillery", stats: { ATK: 7, DEF: 3, HP: 3, MOV: 3, RNG: 30, MOR: 7 }, special: ["Indirect Fire", "Fragment Detonation", "Variable Effect"] },
    { name: "Ember Ballista", faction: "emberclaw-warpack", points_cost: 5, role: "Anti-air", fragment_interactions: "Precision shots", flavor_text: "Designed to bring down drakes and flyers", type: "Artillery", stats: { ATK: 8, DEF: 3, HP: 3, MOV: 3, RNG: 36, MOR: 7 }, special: ["+2 ATK vs Flying", "Armor Piercing"] },

    // SPECIALIST (5 units)
    { name: "Fledgling Swarm", faction: "emberclaw-warpack", points_cost: 2, role: "Cheap flyers", fragment_interactions: "Growth", flavor_text: "Young drakes not yet bonded", type: "Specialist", stats: { ATK: 3, DEF: 2, HP: 1, MOV: 10, RNG: 1, MOR: 6 }, special: ["Flying", "Swarm (multiple count as one unit)", "Spark Breath (6\" weak fire)"] },
    { name: "Immolation Bombers", faction: "emberclaw-warpack", points_cost: 4, role: "Suicide unit", fragment_interactions: "Explosion", flavor_text: "Riders who dive into enemies and detonate", type: "Specialist", stats: { ATK: 6, DEF: 2, HP: 1, MOV: 12, RNG: 1, MOR: 10 }, special: ["Flying", "Fearless", "Kamikaze (6\" blast on contact, unit dies)"] },
    { name: "Phoenix Guard", faction: "emberclaw-warpack", points_cost: 6, role: "Resurrection", fragment_interactions: "Rebirth", flavor_text: "Warriors who rise from their ashes", type: "Specialist", stats: { ATK: 5, DEF: 4, HP: 2, MOV: 5, RNG: 1, MOR: 10 }, special: ["Phoenix Rebirth (auto-revive once)", "Fire Immune", "Inspiring"] },
    { name: "Fragment-Blade Assassins", faction: "emberclaw-warpack", points_cost: 5, role: "Assassins", fragment_interactions: "Stealth kills", flavor_text: "Unbonded killers with fragment daggers", type: "Specialist", stats: { ATK: 6, DEF: 3, HP: 2, MOV: 7, RNG: 1, MOR: 8 }, special: ["Stealth", "Assassinate", "Fragment Blade (ignore armor)"] },
    { name: "Flame Prophets", faction: "emberclaw-warpack", points_cost: 5, role: "Morale warfare", fragment_interactions: "Prophecy", flavor_text: "Madmen who see the future in flames", type: "Specialist", stats: { ATK: 3, DEF: 2, HP: 2, MOV: 5, RNG: 12, MOR: 10 }, special: ["Prophecy (grant rerolls)", "Terror", "Maddening Visions (enemy morale penalty)"] },

    // WAR MACHINES (11 units)
    { name: "Grounded Wyrm", faction: "emberclaw-warpack", points_cost: 15, role: "Super-heavy", fragment_interactions: "Massive fire", flavor_text: "Ancient drake too old to fly", type: "War Machine", stats: { ATK: 9, DEF: 7, HP: 12, MOV: 4, RNG: 3, MOR: 10 }, special: ["Massive", "Cataclysm Breath (24\" cone)", "Earthquake Stomp (AoE melee)"] },
    { name: "Mature War Drake", faction: "emberclaw-warpack", points_cost: 10, role: "Heavy monster", fragment_interactions: "Breath weapon", flavor_text: "Prime-age drake in full power", type: "War Machine", stats: { ATK: 7, DEF: 5, HP: 8, MOV: 10, RNG: 2, MOR: 9 }, special: ["Flying", "Inferno Breath (18\" cone)", "Rending Claws", "Terror"] },
    { name: "Young War Drake", faction: "emberclaw-warpack", points_cost: 7, role: "Medium monster", fragment_interactions: "Fire attacks", flavor_text: "Adolescent drake with volatile fire", type: "War Machine", stats: { ATK: 6, DEF: 4, HP: 6, MOV: 12, RNG: 2, MOR: 8 }, special: ["Flying", "Flame Breath (12\" cone)", "Dive Attack (+2 ATK from altitude)"] },
    { name: "Fire Colossus", faction: "emberclaw-warpack", points_cost: 12, role: "Construct", fragment_interactions: "Fragment powered", flavor_text: "Massive golem animated by fragments", type: "War Machine", stats: { ATK: 8, DEF: 6, HP: 10, MOV: 5, RNG: 6, MOR: 10 }, special: ["Fearless", "Fragment Core (explodes on death)", "Fire Aura (damages nearby enemies)"] },
    { name: "Magma Titan", faction: "emberclaw-warpack", points_cost: 13, role: "Elemental", fragment_interactions: "Lava creation", flavor_text: "Living magma bound to combat", type: "War Machine", stats: { ATK: 8, DEF: 5, HP: 11, MOV: 4, RNG: 8, MOR: 10 }, special: ["Fire Immune", "Creates Lava Terrain", "Magma Blast"] },
    { name: "Drake Nest Mobile", faction: "emberclaw-warpack", points_cost: 9, role: "Spawner", fragment_interactions: "Summons drakes", flavor_text: "Portable hatchery on wheels", type: "War Machine", stats: { ATK: 4, DEF: 6, HP: 8, MOV: 3, RNG: 1, MOR: 10 }, special: ["Spawn Fledglings (1d3 per turn)", "Heavily Armored", "Slow"] },
    { name: "Obsidax (Unique Wyrm)", faction: "emberclaw-warpack", points_cost: 30, role: "Named monster", fragment_interactions: "Legendary", flavor_text: "Tzarak's Obsidian Wyrm partner", type: "War Machine", stats: { ATK: 10, DEF: 8, HP: 18, MOV: 8, RNG: 4, MOR: 10 }, special: ["Flying", "Cataclysm Breath (30\" cone)", "Ancient Power", "Earthquake Landing", "Legendary (one per army)"] },
    { name: "Pyrathax (Unique Ancient)", faction: "emberclaw-warpack", points_cost: 20, role: "Named drake", fragment_interactions: "Commander mount", flavor_text: "Scorchcaller Vex's drake", type: "War Machine", stats: { ATK: 8, DEF: 7, HP: 13, MOV: 10, RNG: 3, MOR: 10 }, special: ["Flying", "Crimson Inferno Breath (20\" cone)", "Ancient Resilience", "Legendary (Vex only)"] },
    { name: "Flame Engine", faction: "emberclaw-warpack", points_cost: 8, role: "Support war machine", fragment_interactions: "Buff aura", flavor_text: "Mobile fragment reactor", type: "War Machine", stats: { ATK: 4, DEF: 5, HP: 7, MOV: 4, RNG: 1, MOR: 10 }, special: ["Fragment Amplification Aura", "Buff Nearby Fire Attacks", "Fragile Core"] },
    { name: "Cinder Golem", faction: "emberclaw-warpack", points_cost: 9, role: "Animated construct", fragment_interactions: "Ash creation", flavor_text: "Golem made from volcanic ash", type: "War Machine", stats: { ATK: 7, DEF: 6, HP: 9, MOV: 5, RNG: 1, MOR: 10 }, special: ["Fearless", "Regeneration (in ash terrain)", "Ash Cloud Aura (blocks LoS)"] },
    { name: "Scorched Titan", faction: "emberclaw-warpack", points_cost: 14, role: "Heavy construct", fragment_interactions: "Demolition", flavor_text: "Massive stone giant wreathed in flame", type: "War Machine", stats: { ATK: 9, DEF: 7, HP: 12, MOV: 4, RNG: 2, MOR: 10 }, special: ["Massive", "Siege Breaker", "Fire Stomp (AoE)", "Slow but Unstoppable"] }
  );
