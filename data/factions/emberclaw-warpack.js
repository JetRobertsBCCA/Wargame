(function() {
  ...
  gameData.units.push(
    ...
    { name: "Emberclaw Warriors", faction: "emberclaw-warpack", points_cost: 2, role: "Standard infantry", fragment_interactions: "Fire buffs", flavor_text: "Standard ground troops with javelin and shield", type: "Infantry", stats: { ATK: 9, DEF: 3, HP: 3, MOV: 5, RNG: 4, MOR: 7 }, special: ["Fire Resistant", "Javelin Thrower"] },
    ...
    { name: "Hatchery Guard", faction: "emberclaw-warpack", points_cost: 2, role: "Defensive infantry", fragment_interactions: "Defensive buffs", flavor_text: "Protectors of the sacred clutches", type: "Infantry", stats: { ATK: 9, DEF: 5, HP: 6, MOV: 4, RNG: 1, MOR: 9 }, special: ["Stubborn", "Hold Ground (+2 DEF if not moving)"] },
    ...
    { name: "Ashwalker Skirmishers", faction: "emberclaw-warpack", points_cost: 2, role: "Fast infantry", fragment_interactions: "Mobility buffs", flavor_text: "Light troops from the old nomadic clans", type: "Infantry", stats: { ATK: 9, DEF: 2, HP: 3, MOV: 7, RNG: 6, MOR: 6 }, special: ["Skirmish", "Retreat and Fire"] },
    ...
    // SPECIALIST (5 units)
    { name: "Fledgling Swarm", faction: "emberclaw-warpack", points_cost: 2, role: "Cheap flyers", fragment_interactions: "Growth", flavor_text: "Young drakes not yet bonded", type: "Specialist", stats: { ATK: 9, DEF: 2, HP: 3, MOV: 10, RNG: 1, MOR: 6 }, special: ["Flying", "Swarm (multiple count as one unit)", "Spark Breath (6\" weak fire)"] },
    ...
    { name: "Obsidax (Unique Wyrm)", faction: "emberclaw-warpack", points_cost: 30, role: "Named monster", fragment_interactions: "Legendary", flavor_text: "Tzarak's Obsidian Wyrm partner", type: "War Machine", stats: { ATK: 30, DEF: 8, HP: 54, MOV: 8, RNG: 4, MOR: 10 }, special: ["Flying", "Cataclysm Breath (30\" cone)", "Ancient Power", "Earthquake Landing", "Legendary (one per army)"] },
    { name: "Pyrathax (Unique Ancient)", faction: "emberclaw-warpack", points_cost: 20, role: "Named drake", fragment_interactions: "Commander mount", flavor_text: "Scorchcaller Vex's drake", type: "War Machine", stats: { ATK: 24, DEF: 7, HP: 39, MOV: 10, RNG: 3, MOR: 10 }, special: ["Flying", "Crimson Inferno Breath (20\" cone)", "Ancient Resilience", "Legendary (Vex only)"] },
